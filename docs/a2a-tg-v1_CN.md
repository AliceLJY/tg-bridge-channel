...
> **范围：** [tg-bridge-channel](https://github.com/AliceLJY/tg-bridge-channel) 仓库下的 `a2a/` 包
...
tg-bridge-channel 的 agent 是**人 + bot + IM 上下文**打包在一起的东西，场景完全不同：
...
A2A-TG 本身是"信封 + 传输 + 防环"三件套。下面这些能力属于 **tg-bridge-channel**（宿主 bridge），不是协议本身的职责：
